...
public class mandarin extends LinearLayout {
    ...
    private int getMandarinResId(int num) {
        switch (num) {
            case 0:
                return R.drawable.dolhareubang;
            case 1:
                return R.drawable.mandarin1;
            case 2:
                return R.drawable.mandarin2;
            case 3:
                return R.drawable.mandarin3;
            case 4:
                return R.drawable.mandarin4;
            case 5:
                return R.drawable.mandarin5;
            case 6:
                return R.drawable.mandarin6;
            case 7:
                return R.drawable.mandarin7;
            case 8:
                return R.drawable.mandarin8;
            case 9:
                return R.drawable.mandarin9;
            default:
    ...
    public void markAsHanrabong() {
        isHanrabong = true;
        setBackgroundColor(Color.parseColor("#F59007"));
